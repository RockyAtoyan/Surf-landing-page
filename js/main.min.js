...
const sliderDots=document.querySelectorAll(".header_slider__dot"),prevBtn=document.querySelector(".header .prev"),nextBtns=document.querySelectorAll(".header .next"),swiper=new Swiper(".header_carousel",{init:!1,speed:800,on:{init:()=>{sliderDots.forEach(e=>e.classList.remove("active")),sliderDots[swiper.realIndex].classList.add("active"),prevBtn.removeAttribute("disabled"),nextBtns.forEach(e=>e.removeAttribute("disabled")),swiper.isBeginning&&prevBtn.setAttribute("disabled",""),swiper.isEnd&&nextBtns.forEach(e=>e.setAttribute("disabled",""))},slideChange:()=>{sliderDots.forEach(e=>e.classList.remove("active")),sliderDots[swiper.activeIndex].classList.add("active"),prevBtn.removeAttribute("disabled"),nextBtns.forEach(e=>e.removeAttribute("disabled")),swiper.isBeginning&&prevBtn.setAttribute("disabled",""),swiper.isEnd&&nextBtns.forEach(e=>e.setAttribute("disabled",""))}}}),mapCards=(prevBtn.addEventListener("click",()=>{swiper.slidePrev()}),nextBtns.forEach(e=>e.addEventListener("click",()=>{swiper.slideNext()})),sliderDots.forEach((e,t)=>{e.addEventListener("click",()=>{swiper.slideTo(t)})}),swiper.init(),document.querySelectorAll(".map_card")),mapDots=document.querySelectorAll(".map_dot__btn"),placesSlider=(document.querySelector(".map").addEventListener("click",e=>{e.target.classList.contains("map_dot__btn")?(mapCards.forEach((e,t)=>{e.classList.remove("active"),mapDots[t].classList.remove("active")}),e.target.nextElementSibling.classList.toggle("active"),e.target.classList.toggle("active")):e.target.closest(".map_dot")||mapCards.forEach((e,t)=>{e.classList.remove("active"),mapDots[t].classList.remove("active")})}),new Swiper(".places_carousel",{slidesPerView:4,loop:!0,speed:1e3,initialSlide:1,breakpoints:{300:{slidesPerView:1},500:{slidesPerView:2},1e3:{slidesPerView:4}}})),placesDotPrev=document.querySelector(".places_navigation button.prev"),placesDotNext=document.querySelector(".places_navigation button.next"),travelSlider=(placesDotPrev.addEventListener("click",()=>{placesSlider.slidePrev()}),placesDotNext.addEventListener("click",()=>{placesSlider.slideNext()}),new Swiper(".travel_carousel",{effect:"cards",speed:800,loop:!0})),travelDots=document.querySelectorAll(".travel_navigation button"),sleepSlider=(travelDots[0].addEventListener("click",()=>{travelSlider.slidePrev()}),travelDots[1].addEventListener("click",()=>{travelSlider.slideNext()}),new Swiper(".sleep_carousel",{effect:"cards",speed:800,loop:!0})),sleepDots=document.querySelectorAll(".sleep_navigation button"),shopSlider=(sleepDots[0].addEventListener("click",()=>{sleepSlider.slidePrev()}),sleepDots[1].addEventListener("click",()=>{sleepSlider.slideNext()}),new Swiper(".shop_carousel",{effect:"cards",speed:800,loop:!0})),shopDots=document.querySelectorAll(".shop_navigation button"),surfDots=(shopDots[0].addEventListener("click",()=>{shopSlider.slidePrev()}),shopDots[1].addEventListener("click",()=>{shopSlider.slideNext()}),document.querySelectorAll(".shop_thumbnail .item button")),burger=(surfDots.forEach(e=>{const t=e.parentElement;e.addEventListener("click",()=>{t.classList.toggle("active")})}),document.querySelector(".footer .places_slide__btn").addEventListener("click",()=>{document.querySelector(".header_logo").scrollIntoView({behavior:"smooth"})}),document.querySelector(".header_burger")),headerPanel=document.querySelector(".header_panel"),body=document.querySelector("body");burger.addEventListener("click",()=>{burger.classList.toggle("active"),headerPanel.classList.toggle("active"),body.classList.toggle("active")});